unit Demo.MaterialBarChart.Sample;
...
type
  TDemo_MaterialBarChart_Sample = class(TDemoBaseFrame)
  public
...
procedure TDemo_MaterialBarChart_Sample.GenerateChart;
var
...
initialization
  RegisterClass(TDemo_MaterialBarChart_Sample);
