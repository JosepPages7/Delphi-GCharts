...
type
  TDemo_LineChart_Sample = class(TDemoBaseFrame)
  public
...
procedure TDemo_LineChart_Sample.GenerateChart;
var
...
begin
  ...
  //Chart.Options.Series(['1: {curveType: ''function''}']);
...
initialization
  RegisterClass(TDemo_LineChart_Sample);
