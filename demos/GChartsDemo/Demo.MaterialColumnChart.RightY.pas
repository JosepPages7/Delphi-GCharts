unit Demo.MaterialColumnChart.RightY;
...
type
  TDemo_MaterialColumnChart_RightY = class(TDemoBaseFrame)
  public
...
procedure TDemo_MaterialColumnChart_RightY.GenerateChart;
var
...
begin
  ...
  Chart.Options.Axes('y', '{0: {side: ''right''}}');
...
initialization
  RegisterClass(TDemo_MaterialColumnChart_RightY);
