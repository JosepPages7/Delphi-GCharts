...
type
  TDemo_BarChart_Stacking = class(TDemoBaseFrame)
  public
...
procedure TDemo_BarChart_Stacking.GenerateChart;
var
...
begin
  ...
  ChartNotStacked.ClassChartType := TcfsGChartProducer.CLASS_BAR_CHART;
  ...
  ChartStacked.ClassChartType := TcfsGChartProducer.CLASS_BAR_CHART;
  ...
  ChartStacked100.ClassChartType := TcfsGChartProducer.CLASS_BAR_CHART;
...
initialization
  RegisterClass(TDemo_BarChart_Stacking);
