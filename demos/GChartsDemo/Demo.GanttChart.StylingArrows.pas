unit Demo.GanttChart.StylingArrows;
...
type
  TDemo_GanttChart_StylingArrows = class(TDemoBaseFrame)
  public
...
procedure TDemo_GanttChart_StylingArrows.GenerateChart;
...
begin
  ...
  Chart.Options.Gantt('arrow', '{angle: 100, width: 5, color: ''green'', radius: 0}');
...
initialization
  RegisterClass(TDemo_GanttChart_StylingArrows);
