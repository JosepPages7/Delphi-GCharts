...
type
  TDemo_LineChart_LogScales = class(TDemoBaseFrame)
  public
...
procedure TDemo_LineChart_LogScales.GenerateChart;
var
...
begin
  ...
  Chart.Options.Title('Log Scales');
  Chart.Options.HAxis('title', 'time');
  Chart.Options.HAxis('logScale', true);
  Chart.Options.HAxis('title', 'time');
  Chart.Options.VAxis('logScale', false);
...
initialization
  RegisterClass(TDemo_LineChart_LogScales);
