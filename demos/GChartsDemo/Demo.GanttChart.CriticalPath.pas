unit Demo.GanttChart.CriticalPath;
...
type
  TDemo_GanttChart_CriticalPath = class(TDemoBaseFrame)
  public
...
procedure TDemo_GanttChart_CriticalPath.GenerateChart;
...
begin
  ...
  // Options
  Chart.Options.Gantt('criticalPathEnabled', true);
  Chart.Options.Gantt('criticalPathStyle', '{stroke: ''#e64a19'', strokeWidth: 5}');
...
initialization
  RegisterClass(TDemo_GanttChart_CriticalPath);
