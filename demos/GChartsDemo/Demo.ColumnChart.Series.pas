...
type
  TDemo_ColumnChart_Series = class(TDemoBaseFrame)
  public
...
procedure TDemo_ColumnChart_Series.GenerateChart;
var
...
initialization
  RegisterClass(TDemo_ColumnChart_Series);
