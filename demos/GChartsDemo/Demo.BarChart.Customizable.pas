unit Demo.BarChart.Customizable;
...
type
  TDemo_BarChart_Customizable = class(TDemoBaseFrame)
  public
...
procedure TDemo_BarChart_Customizable.GenerateChart;
var
...
begin
  ...
  ChartAxisTickColors.ClassChartType := TcfsGChartProducer.CLASS_BAR_CHART;
...
initialization
  RegisterClass(TDemo_BarChart_Customizable);
