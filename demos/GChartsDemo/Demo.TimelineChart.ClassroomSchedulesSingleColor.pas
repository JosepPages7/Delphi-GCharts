unit Demo.TimelineChart.ClassroomSchedulesSingleColor;
...
type
  TDemo_TimelineChart_ClassroomSchedulesSingleColor = class(TDemoBaseFrame)
  public
...
procedure TDemo_TimelineChart_ClassroomSchedulesSingleColor.GenerateChart;
var
...
begin
  ...
  // Options
  Chart.Options.Timeline('singleColor', '#8d8');
...
initialization
  RegisterClass(TDemo_TimelineChart_ClassroomSchedulesSingleColor);
