...
type
  TDemo_ScatterChart_DualY = class(TDemoBaseFrame)
  public
...
procedure TDemo_ScatterChart_DualY.GenerateChart;
var
...
begin
  ...
  Chart.Options.VAxes(['title: ''Hours Studied''', 'title: ''Final Exam Grade''']);
...
initialization
  RegisterClass(TDemo_ScatterChart_DualY);
