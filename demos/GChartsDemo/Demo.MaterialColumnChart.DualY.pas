unit Demo.MaterialColumnChart.DualY;
...
type
  TDemo_MaterialColumnChart_DualY = class(TDemoBaseFrame)
  public
...
procedure TDemo_MaterialColumnChart_DualY.GenerateChart;
var
...
initialization
  RegisterClass(TDemo_MaterialColumnChart_DualY);
