unit Demo.MaterialColumnChart.TopX;
...
type
  TDemo_MaterialColumnChart_TopX = class(TDemoBaseFrame)
  public
...
procedure TDemo_MaterialColumnChart_TopX.GenerateChart;
var
...
begin
  ...
  Chart.Options.Axes('x', '{0: {side: ''top'', label: ''White to move''}}');
...
initialization
  RegisterClass(TDemo_MaterialColumnChart_TopX);
