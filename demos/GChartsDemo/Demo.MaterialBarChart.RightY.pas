unit Demo.MaterialBarChart.RightY;
...
type
  TDemo_MaterialBarChart_RightY = class(TDemoBaseFrame)
  public
...
procedure TDemo_MaterialBarChart_RightY.GenerateChart;
var
...
initialization
  RegisterClass(TDemo_MaterialBarChart_RightY);
