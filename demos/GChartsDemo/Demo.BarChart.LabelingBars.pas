unit Demo.BarChart.LabelingBars;
...
type
  TDemo_BarChart_LabelingBars = class(TDemoBaseFrame)
  public
...
begin
  ...
  Chart2.ClassChartType := TcfsGChartProducer.CLASS_BAR_CHART;
...
initialization
  RegisterClass(TDemo_BarChart_LabelingBars);
