unit Demo.ColumnChart.ColoringColumns;
...
type
  TDemo_ColumnChart_ColoringColumns = class(TDemoBaseFrame)
  public
...
procedure TDemo_ColumnChart_ColoringColumns.GenerateChart;
var
...
begin
  ...
  DefaultChart.ClassChartType := TcfsGChartProducer.CLASS_COLUMN_CHART;
...
initialization
  RegisterClass(TDemo_ColumnChart_ColoringColumns);
